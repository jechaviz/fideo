    ...
    return (
        <div className="space-y-6">
            <section className="rounded-[2.4rem] border border-white/10 bg-[radial-gradient(circle_at_top_right,rgba(163,230,53,0.16),transparent_35%),rgba(15,23,42,0.92)] p-6 shadow-panel md:p-8">
                <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
                    <div className="max-w-3xl">
                        ...
                        <p className="mt-4 max-w-2xl text-sm leading-6 text-slate-300">Tomamos la estructura clara y el contraste premium de Easypoint, pero aterrizados a una mesa de frutas: mas ritmo comercial, mas inventario vivo y menos ruido visual.</p>
                    </div>
                    ...
                    <div className="flex flex-col gap-3 lg:min-w-[320px]">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
                                <p className="text-[10px] font-black uppercase tracking-[0.28em] text-slate-500">Cajas activas</p>
                                <p className="mt-2 text-2xl font-black text-white">{dashboardData.unidadesActivas}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
                ...
                <KpiCard title="Entregas pendientes" value={dashboardData.entregasPendientes.toString()} subtext="Por empacar o asignar a ruta." icon="fa-box-check" accent="border-violet-400/40 bg-violet-400/10 text-violet-200" />
            </section>
